...
import { MapPin, Clock, Edit, Plus, CreditCard, RefreshCw } from "lucide-react"
                  ...
                  <div>
                    {job.is_paid ? (
                      ...
                      <div className="flex items-center">
                        <span className="text-amber-600 mr-2">Payment processing - </span>
                        <form action="/api/payments/update-job-status" method="post">
                          <input type="hidden" name="sessionId" value={job.payment_id} />
                          <button type="submit" className="text-blue-600 hover:text-blue-700 flex items-center">
                            <RefreshCw className="h-4 w-4 mr-1" /> Verify Payment Status
                          </button>
                        </form>
                      </div>
                    ) : (
