...
export const metadata = {
  title: "Privacy Policy | GPJob.au",
  description: "Privacy policy for GPJob.au - how we collect, use, and protect your personal information.",
}
      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="prose max-w-none">
          <p className="text-lg mb-6">
            At GPJob.au, we take your privacy seriously. This Privacy Policy explains how we collect, use, disclose, and
