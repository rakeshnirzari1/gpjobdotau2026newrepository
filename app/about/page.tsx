  ...
  return (
    <div className="container mx-auto px-4 py-12">
      <div className="max-w-4xl mx-auto">
        <h1 className="text-4xl font-bold mb-6">About GPJob.au</h1>

        <div className="mb-8">
          <p className="text-lg mb-4">
            GPJob.au is Australia's dedicated job platform connecting General Practitioners with medical practices
            across the country.
          </p>
          <p className="mb-4">
